...
import { addCwppService } from '../../../services/cwppService'

const AddCwppWidgetPage = () => {
    ...
    const handleCreateData = async (data, e) => {
        ...
        const result = await addCwppService({ token }, input).catch((error) => {
            setLoading(false)
...
export default AddCwppWidgetPage
